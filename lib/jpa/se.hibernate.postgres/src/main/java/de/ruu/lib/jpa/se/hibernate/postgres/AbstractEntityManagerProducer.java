...
public abstract class AbstractEntityManagerProducer
{
	...
	@Inject
	@ConfigProperty(name = "de.ruu.lib.jpa.se.hibernate.postgres.AbstractEntityManagerProducer.dbname", defaultValue = "test")
	private String dbName;

	@Inject
	@ConfigProperty(name = "de.ruu.lib.jpa.se.hibernate.postgres.AbstractEntityManagerProducer.dbuser", defaultValue = "test")
	private String username;

	@Inject
	@ConfigProperty(name = "de.ruu.lib.jpa.se.hibernate.postgres.AbstractEntityManagerProducer.dbpass", defaultValue = "test")
	private String password;

	@Inject
	@ConfigProperty(name = "de.ruu.lib.jpa.se.hibernate.postgres.AbstractEntityManagerProducer.puname", defaultValue = "test")
